...
public static class CheckEngine
{
    ...
    public static IReadOnlyList<ICheck> All() => new ICheck[]
    {
        ...
        new Checks.NetworkPathCheck(),
        new Checks.PageLoadCheck(),
        new Checks.DnsSpeedCheck(),
        new Checks.NetworkSettingsCheck(),
        new Checks.GhostNetworkAdapterCheck(),
        new Checks.NetworkEventCheck(),
        new Checks.ProblemDeviceCheck(),
        new Checks.UsbEventCheck(),
        new Checks.DevicePowerSavingCheck(),
        new Checks.DeadUsbEntryCheck(),
        new Checks.CameraAccessCheck(),
        new Checks.CameraDeviceCheck(),
        new Checks.CpuLoadCheck(),
        new Checks.MemoryPressureCheck(),
        new Checks.ProcessCountCheck(),
        new Checks.StartupLoadCheck(),
        new Checks.PowerPlanCheck(),
        new Checks.LastRealBootCheck(),
        new Checks.SecurityProductCheck(),
